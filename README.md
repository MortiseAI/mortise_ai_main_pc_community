...
| 0.0.2 | release_202502_0.0.2 | 单智能体 & 混合模型（文本模型+推理模型），组件级开发能力 |

### 未来版本计划

| 计划    | 分支                   | 核心功能                                                    |
|:------|:---------------------|:--------------------------------------------------------|
| 0.0.3 | release_202503_0.0.3 | 多智能体 & 混合模型（文本模型+推理模型），工程级开发发能力                         |
| 0.0.4 | release_202504_0.0.4 | 多智能体 & 混合模型（文本模型+推理模型），工程级开发发能力，AI 自动化测试                |
| 0.0.5 | release_202505_0.0.5 | 多智能体 & 混合模型（文本模型+推理模型），工程级开发发能力，AI 自动化测试，AI 自动化监控       |
| 0.0.6 | release_202505_0.0.6 | 多智能体 & 混合模型（文本模型+推理模型），工程级开发发能力，AI 自动化测试，AI 自动化监控，云存储服务 |
...
- MortiseAI PC 依赖包
```
"@mai-community/mai-native-community-lib": "^0.2.4"
```
